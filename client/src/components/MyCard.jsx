  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-white cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        <div className="block">
          <h2 className="font-epilogue font-semibold text-[16px] text-black text-left leading-[26px] truncate">{title}</h2>
          <p className="mt-[5px] font-epilogue font-normal text-black-900 text-left leading-[18px] truncate">{description}</p>
        </div>
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            ...
            <AddReactionSharpIcon alt="user" className="w-1/2 h-1/2 object-contain text-white" />
          </div>
